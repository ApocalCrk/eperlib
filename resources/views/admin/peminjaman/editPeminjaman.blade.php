...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <form class="content-body" id="form-edit-peminjaman">
            @csrf
            @method('PUT')
                    ...
                    <div id="more-info-vertical" class="content" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="number" id="npm" class="form-control" name="npm" placeholder="21071111" value="{{ $peminjaman->npm }}" />
                                </div>
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="nama">Nama</label>
                                    <input type="text" id="nama" class="form-control" name="nama" readonly value="{{ $peminjaman->member->nama }}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="email">Email</label>
                                    <input type="email" id="email" class="form-control" name="email" readonly value="{{ $peminjaman->member->email }}" />
                                </div>
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="program_studi">Program Studi</label>
                                    <input type="text" id="program_studi" class="form-control" name="program_studi" readonly value="{{ $peminjaman->member->program_studi }}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="tanggal_pinjam">Tanggal Pinjam</label>
                                    <input type="date" id="tanggal_pinjam" class="form-control" name="tanggal_pinjam" value="{{ $peminjaman->tanggal_pinjam }}" readonly/>
                                </div>
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="tanggal_kembali">Tanggal Kembali</label>
                                    <input type="date" id="tanggal_kembali" class="form-control" name="tanggal_kembali" value="{{ $peminjaman->tanggal_kembali }}" readonly/>
                                </div>
                            </div>
                        ...
                        <div id="detail-book-vertical" class="content" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="mb-1 form-password-toggle col-md-6">
                                    ...
                                    <input type="text" id="isbn" class="form-control" name="isbn" placeholder="978-3-16-148410-0" value="{{ $peminjaman->isbn }}" />
                                </div>
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="judul">Judul</label>
                                    <input type="text" id="judul" class="form-control" name="judul" readonly value="{{ $peminjaman->buku->judul }}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="penulis">Penulis</label>
                                    <input type="text" id="penulis" class="form-control" name="penulis" readonly value="{{ $peminjaman->buku->penulis }}" />
                                </div>
                                <div class="mb-1 form-password-toggle col-md-6">
                                    <label class="form-label" for="penerbit">Penerbit</label>
                                    <input type="text" id="penerbit" class="form-control" name="penerbit" readonly value="{{ $peminjaman->buku->penerbit }}" />
                                </div>
                            </div>
                            <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        if (typeof verticalWizard !== undefined && verticalWizard !== null) {
            ...
            .on('click', function () {
                $.ajax({
                    url: '/admin/peminjaman/update/{{ $peminjaman->id_transaksi_peminjaman }}',
                    type: 'POST',
                    data: new FormData($('#form-edit-peminjaman')[0]),
                    contentType: false,
                    processData: false,
