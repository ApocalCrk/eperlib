        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Daftar Buku Dipinjam</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/user/dashboard">Halaman Utama</a>
                                </li>
                                <li class="breadcrumb-item active"><a href="#">Daftar Buku Dipinjam</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card knowledge-base-bg text-center">
                            <div class="card-body">
                                <h2 class="text-primary">Selamat Datang di Fitur Pengembalian Buku</h2>
                                <p class="card-text mb-2">
                                    <span>Cari buku yang ingin dikembalikan dan sesuaikan dengan jadwal pengembalian</span>
                                </p>
            ...
            <section id="knowledge-base-content">
                <div class="row kb-search-content-info match-height">
                    ...
                    <div class="col-md-4 col-sm-6 col-12 kb-search-content">
                        <div class="card">
                            <a href="/user/pengembalian_buku/{{ $item->id_transaksi_peminjaman }}">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <small>
                                        <span class="badge bg-danger">
                                            @if($item->pengembalian->status == 'ditolak')
                                            Pengajuan Pengembalian Ditolak
                                            @else
                                            Pengajuan Pengembalian Diproses
                                            @endif
                                        </span>
                                    </small>
                                    @endif
                                ...
                                <div class="card-footer">
                                    <a href="/user/pengembalian_buku/{{ $item->id_transaksi_peminjaman }}" class="btn btn-primary w-100">Detail Peminjaman</a>
                                </div>
                            </a>
                        </div>
                    </div>
